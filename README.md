...
1. **打开 PDF**；
2. 在左侧**点一下要修改的文字**，它会高亮，并自动带出字体/字号/左边框；
3. 填「替换为」，按需设置字体、字号、对齐、范围，然后点**添加到清单**——
   左侧会**立即显示改后的效果**（可加多条）；
4. 点**另存为…** 导出新 PDF。

想对照原文件，勾选工具栏的「对照原图」（单画布切换，不分屏）。

**缩放与滚动**：

- **鼠标滚轮** = 上下滚动；**Shift+滚轮** = 横向；**Ctrl+滚轮** = 缩放（以鼠标位置为中心）；
...
**帮助**：点工具栏「帮助」弹出悬浮说明窗（四步操作、控件说明、常见问题）。
